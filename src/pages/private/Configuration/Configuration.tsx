...
import { ConfigCard } from '@/components/features/dashboard/ConfigCard';
import { IntegrationProvider } from '@/types/integrations';
import { useIntegrations } from '@/hooks/useIntegrations';
import { api } from '@/services/api';
import { IntegrationRequestModal } from '@/components/features/dashboard/IntegrationRequestModal';
    ...
    return (
      <div className="space-y-8">
        <div>
          ...
          <p className="text-white/60 mt-1">Loading integrations...</p>
        </div>
      </div>
    );
  }
