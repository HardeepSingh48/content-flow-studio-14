...
import ContentSessionCard from '@/components/features/content/ContentSessionCard';
import ConfirmDialog from '@/components/features/content/ConfirmDialog';
...
const History = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-white">Your Content Pipeline</h1>
          <p className="text-white/60 mt-1">Manage and track your content creation</p>
        </div>
      ...
      >
        {isLoading ? (
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-12 text-center">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">No content created yet</h2>
            <p className="text-white/60 mb-6">Start by creating your first piece of content</p>
            <Button onClick={() => navigate('/dashboard/create')}>
              <Plus className="w-4 h-4 mr-2" />
              Create Content
            </Button>
