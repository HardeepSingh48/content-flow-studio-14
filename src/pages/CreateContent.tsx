...
import InputTypeCard from '@/components/content/InputTypeCard';
import TagsInput from '@/components/content/TagsInput';
import IdeaCard from '@/components/content/IdeaCard';
import QuestionInput from '@/components/content/QuestionInput';
import PlatformCheckbox from '@/components/content/PlatformCheckbox';
